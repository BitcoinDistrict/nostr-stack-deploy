...
def main() -> None:
    ...
    log_err(
        ...
        + ",".join(fields)
        + f" allow_import={args.allow_import.lower()} eph_rate={args.eph_rate} eph_burst={args.eph_burst} eph_max={args.eph_max_buckets} eph_ttl={args.eph_ttl_seconds}s startup_grace={args.startup_grace_seconds}s"
    )
